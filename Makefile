...
all:
	...
	$(CPP_C) cpp/DetectCPU/DetectCPU.cpp -o objects/cppDetectCPU.o $(CPP_FLAGS) $(CPP_LIBS)

	ld -m elf_i386 -T link.ld -o bin/concreteOS.elf $(OBJ)asmCoreBoot.o $(OBJ)asmCoreIO.o $(OBJ)cppCoreBoot.o $(OBJ)cppCoreVideo.o $(OBJ)cppCoreTerminal.o $(OBJ)cCoreGDT.o $(OBJ)cCoreIDT.o $(OBJ)cppCoreKeyboard.o $(OBJ)cppDetectCPU.o
